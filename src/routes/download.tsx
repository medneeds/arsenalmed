  ...
  return (
    <div className="min-h-screen bg-papel text-tinta">
      ...
      <main className="mx-auto max-w-[760px] px-4 pb-20 pt-24 md:px-6">
        <div className="border border-musgo-300 p-5 text-center md:p-10">
          <div className="flex justify-center">
            <Logo size={56} />
          </div>
          <p className="label mt-6 text-ocre">COMPRA CONFIRMADA</p>
          <h1 className="mt-4 font-heading text-xl font-bold uppercase tracking-wide sm:text-2xl">
            Seus arquivos do Arsenal Med 3.0
          </h1>
          <p className="mx-auto mt-3 max-w-[560px] text-[16px] leading-relaxed text-musgo-600">
            Gere o link somente quando for baixar. Abrir ou atualizar esta página não consome seu limite de
            downloads.
          </p>
          <p className="mx-auto mt-3 max-w-[560px] text-[15px] leading-relaxed text-musgo-600">
            Guarde este endereço: ele fica ativo por 7 dias, com até 5 downloads por volume. Salve os dois PDFs no
            aparelho — a consulta funciona sem internet.
          </p>

          {!token ? (
            <p className="mt-8 border border-alerta/30 bg-alerta/5 p-4 text-sm text-alerta">
              Link de entrega inválido. Use o endereço recebido por e-mail após a compra.
            </p>
          ) : (
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              ...
              <DownloadCard
                ...
                subtitulo="Segundo volume incluído como bônus: fármacos, diluições, doses e 10 tabelas de referência."
                state={catalogo}
                onLiberar={liberar}
              />
            </div>
